        ...
        <div className="d-md-block d-none">
          {user ? (
            <div className="d-flex align-items-center">
              <div className="text-primary text-decoration-none d-flex align-text-center align-cotent-center">
              ...
              <div className="px-4 rounded-pill">
                <button
                  className="btn btn-primary text-white lead fw-bold"
            ...
            <div className="d-flex gap-3 align-items-center">
              <Link to="/login" className="px-4 rounded-pill">
                <button className="btn btn-primary text-white lead fw-bold">
